...
class RuboCop::StringUtil::JaroWinkler < RuboCop::StringUtil::Jaro
  ...
  def compute_distance; end
  def initialize(a, b, boost_threshold = nil, scaling_factor = nil); end
...
module RuboCop::Cop::Util
  ...
  def block_length(block_node); end
  ...
  def line_distance(n1, n2); end
  def line_range(arg); end
  ...
  def parenthesized_call?(send); end
  def preceed?(n1, n2); end
  ...
  def range_with_surrounding_space(range, side = nil, with_newline = nil); end
  def same_line?(n1, n2); end
  def scrub_string(string); end
  def self.begins_its_line?(range); end
  def self.block_length(block_node); end
  def self.comment_line?(line_source); end
  def self.compatible_external_encoding_for?(src); end
  def self.directions(side); end
  ...
  def self.line_distance(n1, n2); end
  def self.line_range(arg); end
  def self.move_pos(src, pos, step, condition, regexp); end
  ...
  def self.preceed?(n1, n2); end
  def self.range_between(start_pos, end_pos); end
  def self.range_by_whole_lines(range, include_final_newline: nil); end
  def self.range_with_surrounding_comma(range, side = nil); end
  def self.range_with_surrounding_space(range, side = nil, with_newline = nil); end
  def self.same_line?(n1, n2); end
  def self.scrub_string(string); end
  def self.source_range(source_buffer, line_number, column, length = nil); end
  ...
  def strip_quotes(str); end
  def stripped_source_upto(line); end
...
class RuboCop::Cop::Cop
  def add_offense(node, loc = nil, message = nil, severity = nil); end
...
class RuboCop::Cop::Generator::RequireFileInjector
  def initialize(require_path); end
  def inject; end
  ...
  def rubocop_root_file_path; end
  def target_line; end
...
module RuboCop::Cop::DocumentationComment
  ...
  def preceding_comment?(n1, n2); end
...
module RuboCop::Cop::FrozenStringLiteral
  ...
  def self.frozen_string_literals_enabled?; end
end
...
class RuboCop::Cop::HashAlignment::KeyAlignment
  ...
  def deltas_for_first_pair(*arg0); end
end
...
module RuboCop::Cop::NegativeConditional
  ...
  def negative_conditional_corrector(node); end
...
module RuboCop::Cop::PercentLiteral
  def autocorrect_words(word_nodes, escape, base_line_number, delimiters); end
...
module RuboCop::Cop::SpaceAfterPunctuation
  ...
  def space_missing?(t1, t2); end
  def space_required_before?(token); end
end
module RuboCop::Cop::SpaceBeforePunctuation
  def autocorrect(pos_before_punctuation); end
  def each_missing_space(tokens); end
  def investigate(processed_source); end
  def space_missing?(t1, t2); end
...
module RuboCop::Cop::SpaceInside
  ...
  def investigate(processed_source); end
  def matching_brackets?(brackets, t1, t2); end
  def range_between_tokens(t1, t2); end
  include RuboCop::Cop::SurroundingSpace
end
class RuboCop::Cop::SpaceInside::Brackets
  def initialize(left, right, kind); end
  def kind; end
  def left_side?(token); end
  def right_side?(token); end
end
module RuboCop::Cop::StatementModifier
  def body_length(body); end
  def comment_lines; end
  def commented?(source); end
  def empty_body?(body); end
  def length_in_modifier_form(node, cond, body_length); end
  def line_count(node); end
...
class RuboCop::Cop::Layout::BlockEndNewline < RuboCop::Cop::Cop
  def autocorrect(node); end
  def indentation_of_block_start_line(node); end
  def message(node); end
  def on_block(node); end
end
...
class RuboCop::Cop::Layout::ExtraSpacing < RuboCop::Cop::Cop
  ...
  def aligned_comments?(token); end
  def aligned_tok?(token); end
  def aligned_with_next_comment?(ix); end
  def aligned_with_previous_comment?(ix); end
  def assignment_tokens; end
  def autocorrect(range); end
  def check_assignment(token); end
  def check_other(t1, t2, ast); end
  def check_tokens(ast, t1, t2); end
  def comment_column(ix); end
  def contiguous_assignment_lines(range); end
  def equal_sign?(token); end
  def extra_space_range(t1, t2); end
...
class RuboCop::Cop::Layout::IndentHash < RuboCop::Cop::Cop
  ...
  def check_based_on_longest_key(pairs, left_brace, left_parenthesis); end
...
class RuboCop::Cop::Layout::SpaceAroundEqualsInParameterDefault < RuboCop::Cop::Cop
  ...
  def message(_); end
  def no_surrounding_space?(arg, equals, value); end
  def on_optarg(node); end
  def space_on_both_sides?(arg, equals, value); end
  include RuboCop::Cop::ConfigurableEnforcedStyle
  include RuboCop::Cop::SurroundingSpace
end
...
class RuboCop::Cop::Layout::SpaceAroundOperators < RuboCop::Cop::Cop
  ...
  def autocorrect(range); end
  def check_operator(op, right_operand); end
  def excess_leading_space?(op, with_space); end
  def excess_trailing_space?(right_operand, with_space); end
  def hash_table_style?; end
  def offense(op, with_space, right_operand); end
  def offense_message(op, with_space, right_operand); end
  def on_and(node); end
  def on_and_asgn(node); end
...
class RuboCop::Cop::Layout::SpaceInsideBlockBraces < RuboCop::Cop::Cop
  ...
  def check_right_brace(inner, right_brace, block_length); end
...
class RuboCop::Cop::Layout::SpaceInsideBrackets < RuboCop::Cop::Cop
  def specifics; end
  include RuboCop::Cop::SpaceInside
end
class RuboCop::Cop::Layout::SpaceInsideHashLiteralBraces < RuboCop::Cop::Cop
  ...
  def autocorrect(range); end
  def check(t1, t2); end
  def expect_space?(t1, t2); end
  def hash_literal_with_braces(node); end
  def incorrect_style_detected(t1, t2, expect_space, is_empty_braces); end
  def left_brace?(token); end
  def message(brace, is_empty_braces, expect_space); end
  def offense?(t1, t2, expect_space); end
  def on_hash(node); end
  def range_of_space_to_the_left(range); end
  def range_of_space_to_the_right(range); end
  def right_brace?(token); end
...
class RuboCop::Cop::Layout::Tab < RuboCop::Cop::Cop
  def autocorrect(range); end
  def investigate(processed_source); end
  def string_literal_lines(ast); end
end
class RuboCop::Cop::Layout::TrailingBlankLines < RuboCop::Cop::Cop
  ...
  def offense_detected(sb, wanted_blank_lines, blank_lines, whitespace_at_end); end
  include RuboCop::Cop::ConfigurableEnforcedStyle
end
...
class RuboCop::Cop::Lint::AmbiguousBlockAssociation < RuboCop::Cop::Cop
  ...
  def lambda_argument?(node = nil); end
  def message(node); end
  def method_as_param?(param); end
  def method_with_block?(param); end
  def on_send(node); end
end
...
class RuboCop::Cop::Lint::BlockAlignment < RuboCop::Cop::Cop
...
class RuboCop::Cop::Lint::ConditionPosition < RuboCop::Cop::Cop
  def check(node); end
  def message(node); end
  def on_if(node); end
  def on_until(node); end
...
class RuboCop::Cop::Lint::DefEndAlignment < RuboCop::Cop::Cop
  def autocorrect(node); end
  def on_def(node); end
  def on_defs(node); end
  def on_send(node); end
...
class RuboCop::Cop::Lint::EndAlignment < RuboCop::Cop::Cop
...
class RuboCop::Cop::Lint::InvalidCharacterLiteral < RuboCop::Cop::Cop
  def alternative_message(diagnostic); end
  def relevant_diagnostic?(diagnostic); end
  include RuboCop::Cop::ParserDiagnostic
end
class RuboCop::Cop::Lint::LiteralInCondition < RuboCop::Cop::Cop
...
class RuboCop::Cop::Lint::RescueWithoutErrorClass < RuboCop::Cop::Cop
  def on_resbody(node); end
  def rescue_without_error_class?(node = nil); end
end
class RuboCop::Cop::Lint::ReturnInVoidContext < RuboCop::Cop::Cop
  def method_name(return_node); end
  def method_setter?(method_name); end
  def on_return(return_node); end
  def useless_return_method?(method_name); end
end
...
class RuboCop::Cop::Lint::ScriptPermission < RuboCop::Cop::Cop
  ...
  def investigate(processed_source); end
  def start_with_shebang?(processed_source); end
end
...
class RuboCop::Cop::Lint::UnneededDisable < RuboCop::Cop::Cop
  ...
  def each_already_disabled(line_ranges, comments); end
...
class RuboCop::Cop::Performance::HashEachMethods < RuboCop::Cop::Cop
  def autocorrect(node); end
  def check_argument(variable); end
  def correct_args(node, corrector); end
  def correct_implicit(node, corrector); end
  def correct_key_value_each(node, corrector); end
  def correct_plain_each(node, corrector); end
  def kv_each(node = nil); end
  def kv_range(outer_node); end
  def on_block(node); end
  def plain_each(node = nil); end
  def plain_range(outer_node); end
  def register_each_offense(node); end
...
class RuboCop::Cop::Style::BracesAroundHashParameters < RuboCop::Cop::Cop
  ...
  def remove_braces_with_whitespace(corrector, node); end
  def right_brace_and_space(loc_end); end
  include RuboCop::Cop::ConfigurableEnforcedStyle
end
...
class RuboCop::Cop::Style::CommentAnnotation < RuboCop::Cop::Cop
  ...
  def first_comment_line?(comments, ix); end
  def investigate(processed_source); end
  include RuboCop::Cop::Style::AnnotationComment
end
...
class RuboCop::Cop::Style::Encoding < RuboCop::Cop::Cop
  ...
  def encoding_mismatch_message; end
  def encoding_omitable?; end
  def encoding_present?(line); end
  def investigate(processed_source); end
  def matching_encoding?; end
...
class RuboCop::Cop::Style::HashSyntax < RuboCop::Cop::Cop
  ...
  def alternative_style; end
  def autocorrect(node); end
  def autocorrect_hash_rockets(corrector, node); end
  def autocorrect_no_mixed_keys(corrector, node); end
  def autocorrect_ruby19(corrector, node); end
...
class RuboCop::Cop::Style::SafeNavigation < RuboCop::Cop::Cop
  ...
  def find_matching_receiver_invocation(node, checked_variable); end
  def modifier_if_safe_navigation_candidate?(node = nil); end
  def not_nil_check?(node = nil); end
  def on_and(node); end
  def on_if(node); end
  def unsafe_method?(method); end
  extend RuboCop::Cop::TargetRubyVersion
end
...
class RuboCop::Cop::Style::SingleLineMethods < RuboCop::Cop::Cop
  def allow_empty?; end
  def autocorrect(node); end
  def break_line_before(range, node, corrector, indent_steps); end
...
class RuboCop::Cop::Style::SpecialGlobalVars < RuboCop::Cop::Cop
  ...
  def format_message(english, regular, global_var); end
  def message(node); end
  def on_gvar(node); end
...
class RuboCop::Cop::Style::TrailingCommaInLiteral < RuboCop::Cop::Cop
...
class RuboCop::Cop::Style::TrailingUnderscoreVariable < RuboCop::Cop::Cop
  ...
  def left_side_range(left, right); end
  def on_masgn(node); end
...
class RuboCop::Cop::Rails::Delegate < RuboCop::Cop::Cop
  def arguments_match?(args, body); end
  def autocorrect(node); end
  def delegate?(body); end
  ...
  def trivial_delegate?(method_name, args, body); end
end
...
class RuboCop::Cop::Rails::HasManyOrHasOneDependent < RuboCop::Cop::Cop
  def has_dependent?(node = nil); end
  def is_has_many_or_has_one_with_options?(node = nil); end
  def is_has_many_or_has_one_without_options?(node = nil); end
  def on_send(node); end
end
...
class RuboCop::Cop::Team
  ...
  def handle_error(e, location, cop); end
  def handle_warning(e, location); end
...
class RuboCop::Formatter::DisabledConfigFormatter < RuboCop::Formatter::BaseFormatter
  ...
  def output_cop_comments(output, cfg, cop_name, offense_count); end
  def output_cop_config(output, cfg, cop_name); end
  def output_cop_param_comments(params, default_cfg); end
  def output_exclude_list(output, offending_files, cop_name); end
  def output_exclude_path(output, file, parent); end
  def output_offending_files(output, cfg, cop_name); end
...
class RuboCop::ConfigLoader
  ...
  def self.auto_gen_config?; end
  def self.base_configs(path, inherit_from); end
  def self.clear_options; end
  def self.config_files_in_path(target); end
  def self.configuration_file_for(target_dir); end
  def self.configuration_from_file(config_file); end
  def self.create_config(hash, path); end
  def self.debug; end
  def self.debug=(arg0); end
  def self.debug?; end
  def self.default_configuration; end
  def self.default_configuration=(arg0); end
  def self.dirs_to_search(target_dir); end
  def self.gem_config_path(gem_name, relative_config_path); end
  def self.handle_disabled_by_default(config, new_default_configuration); end
...
class RuboCop::Options
  ...
  def add_configuration_options(opts, args); end
